 ...
 * 默认刷新效果
 */
public class ImplRecyclerViewRefreshStateCall implements SwipeRefreshLayout.RecyclerViewRefreshStateCall {
	...
	public ImplRecyclerViewRefreshStateCall(SwipeRefreshLayout pullRefreshRecyclerView) {
