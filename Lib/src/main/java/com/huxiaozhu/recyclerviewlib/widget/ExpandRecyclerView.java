...
//        if (adapter instanceof BaseAdapter && mAdapter.getItemCount()>0){
//            addItemDecoration(new RecyclerDivider(dividerHeight,
//                    (BaseAdapter) adapter, getResources().getColor(dividerColor), ((BaseAdapter) adapter).getNumColums()));
//        }
//    }
