...
public class SwipeRefreshLayout extends LinearLayout {
	...
	boolean flag=false;
	public SwipeRefreshLayout(Context context, @Nullable AttributeSet attrs) {
		super(context, attrs);
...
//       在这里以flag作为一个标识，第一遍走initAttrs时，将flag设为true，也就是第二次才走initView
	...
	public SwipeRefreshLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
